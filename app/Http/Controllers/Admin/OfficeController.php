...
class OfficeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.offices.index', compact('offices', 'regions'));
    }
    ...
    public function show(Office $office)
    {
        ...
        $office->load('region', 'officeNamePostingAllocations', 'divisionVehicleAllocations', 'officeNameDriverAllocations', 'officeNameMaintenanceHistories', 'officeEmployees');
