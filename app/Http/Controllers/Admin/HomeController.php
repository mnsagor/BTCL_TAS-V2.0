...
class HomeController
{
    ...
    {
        $settings1 = [
            'chart_title'           => 'Total Vehicle',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Vehicle',
            'group_by_field'        => 'ragistration_date',
            'group_by_period'       => 'day',
        ...
        $settings6 = [
            'chart_title'           => 'Total Driver',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Driver',
            'group_by_field'        => 'dl_validity_year',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            'group_by_field_format' => 'd/m/Y',
        ...
        $settings7 = [
            'chart_title'        => 'Number of Vehicles according to Region',
            'chart_type'         => 'bar',
            'report_type'        => 'group_by_relationship',
            'model'              => 'App\Models\VehicleAllocation',
            'group_by_field'     => 'name',
            'aggregate_function' => 'count',
            'filter_field'       => 'created_at',
        ...
        $settings8 = [
            'chart_title'        => 'Number of Drivers according to Region',
            'chart_type'         => 'bar',
            'report_type'        => 'group_by_relationship',
            'model'              => 'App\Models\PostingAllocation',
            'group_by_field'     => 'name',
            'aggregate_function' => 'count',
            'filter_field'       => 'created_at',
            'column_class'       => 'col-md-6',
            'entries_number'     => '5',
            'relationship_name'  => 'region_name',
        ];

        $chart8 = new LaravelChart($settings8);

        $settings9 = [
            'chart_title'        => 'Maintenance History according to region',
            'chart_type'         => 'bar',
            'report_type'        => 'group_by_relationship',
            'model'              => 'App\Models\MaintenanceHistory',
            'group_by_field'     => 'name',
            'aggregate_function' => 'count',
            'filter_field'       => 'created_at',
            'filter_period'      => 'year',
        ...
        $settings10 = [
            'chart_title'        => 'Maintenance History according to Office',
            'chart_type'         => 'bar',
            'report_type'        => 'group_by_relationship',
            'model'              => 'App\Models\MaintenanceHistory',
            'group_by_field'     => 'name',
            ...
            'column_class'       => 'col-md-12',
            'entries_number'     => '5',
            'relationship_name'  => 'office_name',
        ];

        $chart10 = new LaravelChart($settings10);

        $settings11 = [
            'chart_title'        => 'Number of Vehicles according to Office',
            'chart_type'         => 'bar',
            'report_type'        => 'group_by_relationship',
            'model'              => 'App\Models\VehicleAllocation',
            'group_by_field'     => 'name',
            ...
            'column_class'       => 'col-md-12',
            'entries_number'     => '5',
            'relationship_name'  => 'division',
        ];

        $chart11 = new LaravelChart($settings11);

        $settings12 = [
            'chart_title'        => 'Maintenance History according to Allotee',
            'chart_type'         => 'bar',
            'report_type'        => 'group_by_relationship',
            'model'              => 'App\Models\VehicleAllocation',
            'group_by_field'     => 'name',
            ...
            'column_class'       => 'col-md-12',
            'entries_number'     => '5',
            'relationship_name'  => 'allottee_name',
        ];

        $chart12 = new LaravelChart($settings12);

        return view('home', compact('settings1', 'settings2', 'settings3', 'settings4', 'settings5', 'settings6', 'chart7', 'chart8', 'chart9', 'chart10', 'chart11', 'chart12'));
    }
}
