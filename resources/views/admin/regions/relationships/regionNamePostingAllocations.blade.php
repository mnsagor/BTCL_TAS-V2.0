            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-regionNamePostingAllocations">
                            <thead>
                                <tr>
                                    <th width="10">
...
@endcan
  ...
  let table = $('.datatable-regionNamePostingAllocations:not(.ajaxTable)').DataTable({ buttons: dtButtons })
