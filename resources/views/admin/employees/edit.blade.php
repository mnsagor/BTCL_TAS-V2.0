                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('payroll_emp') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="payroll_emp" id="payroll_emp" value="{{ old('payroll_emp', $employee->payroll_emp) }}">
                        ...
                        <div class="form-group {{ $errors->has('is_active') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Employee::IS_ACTIVE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="is_active_{{ $key }}" name="is_active" value="{{ $key }}" {{ old('is_active', $employee->is_active) === (string) $key ? 'checked' : '' }}>
