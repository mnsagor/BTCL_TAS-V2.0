                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.vehicles.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('model_year') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="model_year" id="model_year" value="{{ old('model_year', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('engine_capacity') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="engine_capacity" id="engine_capacity" value="{{ old('engine_capacity', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('chassis_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="chassis_number" id="chassis_number" value="{{ old('chassis_number', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('engine_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="engine_number" id="engine_number" value="{{ old('engine_number', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('condition') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="condition" id="condition">
                                ...
                                @foreach(App\Models\Vehicle::CONDITION_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('condition', 'Medium') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('ragistration_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="ragistration_date" id="ragistration_date" value="{{ old('ragistration_date') }}">
                        ...
                        <div class="form-group {{ $errors->has('fc_start_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="fc_start_date" id="fc_start_date" value="{{ old('fc_start_date') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('fc_end_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="fc_end_date" id="fc_end_date" value="{{ old('fc_end_date') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('tt_start_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="tt_start_date" id="tt_start_date" value="{{ old('tt_start_date') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('tt_end_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="tt_end_date" id="tt_end_date" value="{{ old('tt_end_date') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('fuel_types') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="fuel_types[]" id="fuel_types" multiple>
                                @foreach($fuel_types as $id => $fuel_type)
                                    <option value="{{ $id }}" {{ in_array($id, old('fuel_types', [])) ? 'selected' : '' }}>{{ $fuel_type }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('fuel_consumption_rate') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="fuel_consumption_rate" id="fuel_consumption_rate" value="{{ old('fuel_consumption_rate', '5') }}">
                        ...
                        <div class="form-group {{ $errors->has('engine_overhaulting_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="engine_overhaulting_date" id="engine_overhaulting_date" value="{{ old('engine_overhaulting_date') }}">
                        ...
                        <div class="form-group {{ $errors->has('vehicle_source') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="vehicle_source" id="vehicle_source" value="{{ old('vehicle_source', '') }}">
