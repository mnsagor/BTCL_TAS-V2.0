    ...
    @can('vehicle_allocation_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                ...
                @include('csvImport.modal', ['model' => 'VehicleAllocation', 'route' => 'admin.vehicle-allocations.parseCsvImport'])
            </div>
        </div>
    @endcan
    <div class="row">
...
@endcan
  ...
  let table = $('.datatable-VehicleAllocation:not(.ajaxTable)').DataTable({ buttons: dtButtons })
