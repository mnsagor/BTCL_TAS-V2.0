    ...
    @can('driver_allocation_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                ...
                @include('csvImport.modal', ['model' => 'DriverAllocation', 'route' => 'admin.driver-allocations.parseCsvImport'])
            </div>
        </div>
    @endcan
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-DriverAllocation">
                            <thead>
                                <tr>
                                    <th width="10">
...
@endcan
  ...
  let table = $('.datatable-DriverAllocation:not(.ajaxTable)').DataTable({ buttons: dtButtons })
